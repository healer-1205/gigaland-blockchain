...
(function ($) {
  ...
  function dark_scheme() {
    ...
    $("header").css("backgroundColor", "#1c1917");
    $("header").addClass("text-white");
    $(".c-jrMzNf").attr("data-state", "checked");
    $("html").css("background", "#010203");
    $(".searchh").addClass("border-stone-700");
    $(".searchh").addClass("bg-stone-800");
    $(".searchh").removeClass("border-2");
    $(".searchh").removeClass("border-gray-300");
    $("html").removeClass("light");
    $("html").addClass("dark");
    $("html").css("backgroundColor", "#1a1a25");
  ...
  function light_scheme() {
    $(".ss_light").hide();
    $(".ss_dark").show();
    $(".searchh").removeClass("border-stone-700");
    $(".searchh").removeClass("bg-stone-800");
    $(".searchh").addClass("border-2");
    $(".searchh").addClass("border-gray-300");
    ...
    $(".c-jrMzNf").removeAttr("data-state");
