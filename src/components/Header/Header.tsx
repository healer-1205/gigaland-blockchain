  ...
  return (
    <header className="header_bar">
      ...
      <div className="menu_container">
        ...
        <Link to="/collection">New Collections</Link>
        <Link to="/create">Create</Link>
        <Link to="/profile">Profile</Link>
        <a href="https://twitter.com/TopazMarket" target="_blank" rel="noopener noreferrer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 16 16"
            width="1.25em"
        ...
        <a href="https://discord.gg/SWVxuJkFSH" target="_blank" rel="noopener noreferrer">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 16 16"
            width="1.25em"
      ...
      <div className="connect_btn">
        <div className="btn_container">
          ...
          <div className="flex-shrink-0 whitespace-nowrap">Connect Wallet</div>
        </div>
      </div>
    </header>
  )
